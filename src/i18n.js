export const LANGS = {
  en: {
    ...
    guide_hint_forge: 'Buy in the Forge for embers — kept permanently',
    perk_hook_range: 'Hook Range',
    perk_hook_range_desc: '+4% hook distance per level',
    perk_swing_power: 'Swing Power',
    perk_swing_power_desc: '+3% throw speed per level',
    perk_quick_hook: 'Quick Hook',
    perk_quick_hook_desc: '-10% cooldown per level',
    perk_ember_magnet: 'Ember Magnet',
    perk_ember_magnet_desc: '+10% ember collection per level',
    perk_max_level: 'MAX LVL',
    saw_name: 'Saw Blade',
  ...
  ru: {
    ...
    guide_hint_forge: 'Покупаются в Кузнице за угли — сохраняются навсегда',
    perk_hook_range: 'Дальность крюка',
    perk_hook_range_desc: '+4% дистанция зацепа за уровень',
    perk_swing_power: 'Сила маятника',
    perk_swing_power_desc: '+3% скорость броска за уровень',
    perk_quick_hook: 'Быстрый крюк',
    perk_quick_hook_desc: '-10% кулдаун за уровень',
    perk_ember_magnet: 'Магнит углей',
    perk_ember_magnet_desc: '+10% сбор углей за уровень',
    perk_max_level: 'МАКС УР',
    saw_name: 'Пила',
